...
public class MainActivity extends Activity {
    ...
    private static final String HOME_URL = "https://shade-thread-adapted-venue.trycloudflare.com ";
    private static final String ALLOWED_HOST = "shade-thread-adapted-venue.trycloudflare.com";
