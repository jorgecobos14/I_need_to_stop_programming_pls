...
public class MainActivity extends Activity {
    ...
    private static final String HOME_URL = "https://letter-lately-examining-window.trycloudflare.com";
    private static final String ALLOWED_HOST = "letter-lately-examining-window.trycloudflare.com";
