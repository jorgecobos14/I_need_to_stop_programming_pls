...
public class MainActivity extends Activity {
    ...
    private static final String HOME_URL = "https://parameter-cod-idle-wto.trycloudflare.com";
    private static final String ALLOWED_HOST = "parameter-cod-idle-wto.trycloudflare.com";
